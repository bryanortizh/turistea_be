...
import { createFormReserveController } from "../../form_reserve/controller/form_reserve.controller";
...
router.post("/form_reserves", validateCreateFormReserve, createFormReserveController);