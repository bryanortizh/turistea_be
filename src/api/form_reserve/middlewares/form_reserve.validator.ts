...
export const validateCreateFormReserve = [
  ...
  body("id_package")
    .isInt({ min: 1 })
    .withMessage("El ID del paquete es requerido y debe ser un número entero positivo"),
  ...
  body("status_form")
    ...
    .withMessage("El estado del formulario debe ser: pending, confirmed, cancelled o completed"),
...
export const validateGetFormReserves = [
  ...
  query("status")
    .optional()
    .isIn(["pending", "confirmed", "cancelled", "completed"])
    .withMessage("El estado debe ser: pending, confirmed, cancelled o completed"),
